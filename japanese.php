...
$_LANG['contactFormPlaceholder'] = "⚠ご利用のデータが尽きていないことを確認してください。残りのデータはサービス詳細ページでご確認いただけます

接続に問題がある場合は、以下の情報を含めてお問い合わせください：
1. ご使用のデバイスのOS名とバージョン情報
2. ご使用のデバイスのモデル名
3. 使用国と地域
4. 問題のあるアプリ名とそのバージョン
5. アプリ内で設定されたモードまたはサーバーリストのスクリーンショット
6. 接続エラー画面のスクリーンショット
";


$_LANG['Rule_Title']="該当するルール名";
$_LANG['Rule_Descs']="該当するルールの概要";
$_LANG['Rule_Mode']="適用可能なルール";
$_LANG['Rule_More']="適用可能なルール";
$_LANG['Rule_Unavailable']="利用できません";
$_LANG['Rule_Reset']="クリックしてルールを実行";
$_LANG['Rule_Reset_Button']="クリックしてください、クリックしてください";
$_LANG['Page_Title']="こんにちは、今日は何をリセットしますか？";
$_LANG['Minus_Day_After']="実行後の有効期限";
$_LANG['Rule_Reset_Comfirm']="続行してもよろしいですか";
$_LANG['Rule_Reset_Comfirm_Yes']="OK";
$_LANG['Rule_Reset_Comfirm_No']="とにかく忘れてください";
$_LANG['Rule_Reset_Server_Error']="サーバーエラーが発生しました...後でもう一度やり直してください...";
$_LANG['Rule_Rule_Reset_Success']="ルールは正常に実行されました〜";

$_LANG['freetrial'] = "無料お試し";
$_LANG['plsclick'] = "上のボタンをクリックしてください";
$_LANG['plstoggleoffvpn'] = "⚠リダイレクトできない場合はVPNを切断してからクリックしてください";
...
$_LANG['affiliatesreferallink'] = "友達紹介で最大40%の成功報酬  リンク↓";
...
$_LANG['clientareacancelproduct'] = "キャンセルをリクエストする（返金不可）";
...
$_LANG['or'] = "or";
$_LANG['orderadditionalrequiredinfo'] = "その他必要な情報";
...
$_LANG['orderdontusepromo'] = "プロモーションコードを使用しない";
...
$_LANG['orderpaymenttermannually'] = "年払い(-15%)";
$_LANG['orderpaymenttermbiennially'] = "二年払い(-20%)";
$_LANG['orderpaymenttermfreeaccount'] = "無料アカウント";
$_LANG['orderpaymenttermmonthly'] = "月払い";
$_LANG['orderpaymenttermonetime'] = "1回";
$_LANG['orderpaymenttermquarterly'] = "3ヶ月払い(-5%)";
$_LANG['orderpaymenttermsemiannually'] = "半年払い(-10%)";
$_LANG['orderprice'] = "料金";
...
$_LANG['orderpromotioncode'] = "クーポンコード";
...
$_LANG['orderyears'] = "年";
$_LANG['orderyourinformation'] = "お客様情報";
$_LANG['orderyourorder'] = "お客様のご注文";
$_LANG['organizationname'] = "会社名";
...
$_LANG['serverhostname'] = "ホストネーム";
$_LANG['serverlogindetails'] = "ログイン詳細情報";
...
$_LANG['viewcart'] = "カート";
$_LANG['welcomeback'] = "おかえりなさい";
$_LANG['whoisresults'] = "WHOIS Results for";
$_LANG['yes'] = "はい";
$_LANG['yourdetails'] = "お客様の基本情報";
...
$_LANG['orderpaymenttermtriennially'] = "三年払い(-25%)";
$_LANG['orderpaymentterm36month'] = "36カ月の価格";
...
$_LANG['cartnewcustomer'] = "私は初めてです。";
$_LANG['cartexistingcustomer'] = "私は登録済みです。";
...
$_LANG['cartchooseanothercategory'] = "その他のカテゴリ";
...
$_LANG['navtickets'] = "サポート";
$_LANG['navopenticket'] = "サポート";
...
$_LANG['networkstatustitle'] = "ステータス";
...
////////// End of Japanese language file.  Do not place any translation strings below this line!
